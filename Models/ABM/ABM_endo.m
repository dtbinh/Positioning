function [o_mean_eccentricity, o_ENP, o_mean_share, o_N, o_mean_age_death] = ABM_endo(pref)
...
%     end
     ...
     %%% 4.4 Function output
     o_mean_eccentricity = [mean_eccentricity mean_eccentricity_rule];
     o_ENP = ENP;
     o_mean_share = [mean_share mean_share_rule];
     o_N = [N N_rule];
     o_mean_age_death = [mean_age_death mean_age_death_rule];
