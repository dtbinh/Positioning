...
b = pref.boundary/2;
    ...
    mean_forecasterror      = NaN(pref.iterations*pref.psi, 1);
...
for i = 1:pref.iterations*pref.psi
    ...
    if(i==1) 
        ...
        % Update accuracy
        [cf_i, forecasterror_i] = accuracy(xy(:,:,i), xy(:,:,i-1), active_cf_i, cf_i, pref.a_a);
        mean_forecasterror(i) = forecasterror_i;
